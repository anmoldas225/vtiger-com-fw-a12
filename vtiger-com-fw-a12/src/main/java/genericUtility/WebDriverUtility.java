...
/*
 * This class contains reusable WebDriver utility methods such as window management, waits, DropDown selections, mouse and keyboard interactions. 
 * It also includes additional utilities such as alerts, scrolling, screenshot, JSexecution, drag-drop, sliders, and more.
*/
...
/*
	 * Implicitly wait for all WebElement present in Test Script .
*/	
...
/*
	 * Makes the WebSite Open on which we will perform operation.
*/	
	public void url() {
...
/*
         ...
         * @param value   Value of the option
*/		
         public void selectbyvisibiletext(WebElement element, String visibletext) {
	         sel = new Select(element);
	         sel.selectByVisibleText(visibletext);
      }

/*
		 * Selects DropDown getOptions.
		 * 
		 * @param element The DropDown WebElement
*/
         public List<String> getOptions(WebElement element){
	            sel = new Select(element);
 	            List<WebElement> Details  = sel.getOptions(); 
